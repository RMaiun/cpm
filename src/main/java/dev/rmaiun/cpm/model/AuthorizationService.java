...
public class AuthorizationService {
  ...
  public AuthorizationResultDto authorizeUser(String user, AuthorizeUserDto dto) {
    var userCanPerformAuth = userGroupService.checkUserAssignedToGroup(user, dto.app(), Constants.APP_MANAGERS_GROUP);
    ...
    var groups = userGroupService.findGroupsForUserByDomain(dto.app(), dto.domain(), dto.authType(), dto.user()).stream()
