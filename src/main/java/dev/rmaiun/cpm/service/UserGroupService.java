...
public class UserGroupService {
    ...
    public Map<String, List<String>> assignUserToGroup(Application app, Map<String, List<String>> groupUsers) {
        var appGroups =
                groupRepository.listByApp(app.code()).stream().collect(toMap(BusinessGroup::code, BusinessGroup::id));
        ...
        return existUserGroupRelations.stream().collect(groupingBy(Pair::getKey, mapping(Pair::getValue, toList())));
    }
