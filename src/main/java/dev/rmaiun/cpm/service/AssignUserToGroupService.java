...
public class AssignUserToGroupService {
    ...
    public AssignUserToGroupService(UserGroupService userGroupService, ApplicationRepository applicationRepository) {
    ...
    public UserGroupStatsDto assignUserToGroups(String user, AssignUserToGroupDto dto) {
        ...
        var app = applicationRepository.getByCode(dto.app()).orElseThrow(() -> new AppNotFoundException(dto.app()));
        var groupUsers = dto.groups().stream()
